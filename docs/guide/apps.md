...
Applications in HomeOS are written in the Home programming language and have access to kernel APIs through system calls.
...
- File system access via VFS
- Network connectivity via socket API
- Graphics via framebuffer
- Input via keyboard/mouse drivers

## Related Documentation

- [Architecture](/guide/architecture) - System integration
- [System Calls](/api/syscalls) - API reference
- [File Systems](/guide/filesystems) - File operations
