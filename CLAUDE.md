...
📖 **See:** `IMPLEMENTATION_STATUS.md` (auto-generated by `scripts/generate_status.py`) for the verified feature/boot audit. The former `HOME_KERNEL_FEATURES.md` never existed in-tree and has been folded into the status page.
